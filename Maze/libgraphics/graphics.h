 ...
 * giving their i and j coordinates.  These coordinates are
 ...
 * (i, j), without drawing a line.  The model is that of
 ...
 * point by moving the pen dx inches in the i direction
 * and dy inches in the j direction.  The final position
 ...
 * position along the i-axis, as in traditional mathematics.
 ...
 *        j = GetCurrentY();
 * -----------------------------------
 * These functions return the current i and j positions.
 */
