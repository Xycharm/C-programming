 ...
 *
 * Examples:
 *   To change the value of j so that it indicates the next text
 *   line, you need to execute
 *
 *        j -= GetFontHeight();
 *
 *   To center text vertically around the coordinate j, you need
 *   to start the pen at
 *
 *       j - GetFontAscent() / 2
 */
 ...
 *        j = GetMouseY();
 * -------------------------------
 * These functions return the i and j coordinates of the mouse,
 ...
 * uniformly in terms of dot spacing.  Even though the i and j
