 ...
 * Usage: OpenFileDialog("文本文件(*.txt)\0*.txt", filename);
 * -----------------------
 * This function opens a file dialog to get the path of
 * the file to open.
 *   char filename[1024] = { 0 };
 *   bool b = OpenFileDialog("文本文件(*.txt)\0*.txt", filename);
 *   if (b) {
 ...
 * Usage: SaveFileDialog("文本文件(*.txt)\0*.txt", filename);
 * -----------------------
 * This function opens a file dialog to get the path of
 * the file to save.
 *   char filename[1024] = { 0 };
 *   int b = SaveFileDialog("文本文件(*.txt)\0*.txt", filename);
 *   if (b) {
 *       FILE *fp = fopen(filename, ......
 *       ......
 *   }
...
/*
 * Function: DrawImage
 * Usage: DrawImage("image.bmp", 0, 0, 512, 512, 0, 0, 256, 256);
 * -----------------------
 * This function draws a bmp image provided by the path.
 */
...
/*
 * Function: DrawImage
 * Usage: ClearImageRegion(0, 0, 256, 256);
 * -----------------------
 * This function clear the context in the region.
 *   DrawImage("image1.bmp", 0, 0, 512, 512, 0, 0, 256, 256);
 *   ClearImageRegion(0, 0, 128, 128);
 *   DrawImage("image2.bmp", 128, 128, 256, 256, 124, 124, 800, 500);
 */
...
static void InitColors(void)
{
    ...
    DefineColor("Light Gray", .81, .81, .81);
